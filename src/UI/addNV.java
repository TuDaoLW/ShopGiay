...
public class addNV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nhân viên", "Quản lý", "Chủ tịch", " " }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DB.pushData("INSERT INTO dbo.NhanVien (Username, Password, HoTen, GioiTinh, DiaChi, SDT, TrangThaiTaiKhoan, Luong, ChucVu) \n"
                + "	VALUES ('" + usrname.getText() + "',"
                + " '" + password.getText() + "', "
                + "'" + name.getText() + "',"
                + " " + gioitinh + ","
                + " '" + address.getText() + "',"
